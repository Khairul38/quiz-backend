...
exports.deleteSingleUserFromDB = exports.updateSingleUserToDB = exports.getSingleUserFromDB = exports.getAllUserFromDB = void 0;
...
const getAllUserFromDB = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const resultWithoutPassword = result.map(r => (0, prismaExcludeHelper_1.prismaExclude)(r, ["password"]));
...
const getSingleUserFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "There is no user with the id");
    }
});
...
const updateSingleUserToDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "There is no user with the id/Failed to update user");
    }
});
